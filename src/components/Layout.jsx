...
{ toggle && 
      ...
      <Outlet />
      <footer className="fixed bottom-0 left-0 z-20 w-full p-2 bg-gray-800 border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
    ...
    { !isMobile &&
    <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-200 dark:text-gray-400 sm:mt-0 me-3">
        <li className="mb-2">
